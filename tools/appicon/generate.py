...
# ── 设计常量 ──────────────────────────────────────────────────────────
# 品牌色**墨蓝**。⚠️ 必须和 shared/.../ui/theme/Theme.kt 里的 BrandBlue 一致 ——
# 图标和界面脱节比图标丑更糟。改配色两边一起改。
BRAND      = (31, 78, 133)      # #1F4E85，= Theme.kt 的 BrandBlue，也是「旺」字色
BG_TOP     = (247, 249, 252)    # 米白偏冷，竖向微渐变
BG_BOT     = (230, 237, 246)
